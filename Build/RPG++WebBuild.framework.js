...
var ASM_CONSTS = {
  3659392: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3659453: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3659517: function() {return Module.webglContextAttributes.powerPreference;},  
 3659575: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3659630: function($0) {performance.now = function() { return $0; };},  
 3659678: function($0) {performance.now = function() { return $0; };},  
 3659726: function() {performance.now = Module['emscripten_get_now_backup'];}
};
